...
// Define simulatedApiDelay as it's used in the function but not defined in the provided snippet
const simulatedApiDelay = 500; // You can adjust this value as needed
...
export const fetchPredictionData = async (machineId, startDate, startTime, endDate, endTime) => {
    return new Promise((resolve, reject) => {
        setTimeout(() => {
            ...
            // Convert filter date/time strings to epoch milliseconds
